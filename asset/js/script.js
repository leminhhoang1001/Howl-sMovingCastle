//Howl's Moving Castle
    ...
    if (document.readyState == 'complete') {
        init();
        // const merrySound = new Audio("./asset/audio/merr-go-round.mp3")
        // const merrySound2 = new Howl({
        //     src: ['./asset/audio/merr-go-round.mp3'],
        //     mute: false,
        //     volume: 1
        //   });
        //   merrySound2.mobileAutoEnable = true;
        // if(iosPlatforms.indexOf(platform) !== -1){merrySound2.play();}
        // else{merrySound.autoplay = true;
        //     merrySound.load();
        //     merrySound.play();}
    } else {
        $(window).load(init);
